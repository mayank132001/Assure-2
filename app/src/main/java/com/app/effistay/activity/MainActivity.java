...
import com.app.effistay.fragment.FacilitiesFragment;
import com.app.effistay.fragment.GalleryFragment;
import com.app.effistay.fragment.Home2Fragment;
import com.app.effistay.fragment.MyBookingFragment;
import com.app.effistay.fragment.RoomFragment;
import com.app.effistay.fragment.SettingFragment;
...
import com.app.effistay.util.Constant;
import com.app.effistay.util.Method;
import com.app.effistay.R;
import com.app.effistay.fragment.ProfileFragment;
...
//    private ConsentForm form;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout_main, new Home2Fragment(),
        ...
        switch (id) {
            ...
            case R.id.home:
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout_main,
                        new Home2Fragment(), getResources().getString(R.string.home)).commitAllowingStateLoss();
                return true;
...
//                        new LocationFragment(), getResources().getString(R.string.location)).commitAllowingStateLoss();
            ...
            case R.id.mybooking:
                ...
                selectDrawerItem(6);
                getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout_main,
                        new MyBookingFragment(), getResources().getString(R.string.my_booking)).commitAllowingStateLoss();
                return true;
