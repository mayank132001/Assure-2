...
import com.app.effistay.activity.ContactUs;
import com.app.effistay.activity.Faq;
import com.app.effistay.activity.PrivacyPolicy;
import com.app.effistay.activity.RefundCacellation;
import com.app.effistay.activity.SplashScreen;
import com.app.effistay.activity.TermsConditions;
...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MaterialTextView textViewRnC = view.findViewById(R.id.textView_rnc_setting);
        ...
        textViewRnC.setOnClickListener(v -> startActivity(new Intent(getActivity(), RefundCacellation.class)));
